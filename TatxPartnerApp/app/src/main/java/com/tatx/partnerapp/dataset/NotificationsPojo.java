...
public class NotificationsPojo {
    ...
    {
        return "ClassPojo [message = "+message+", id = "+id+", send_to_roles = "+send_to_roles+", updated_at = "+updated_at+", status = "+status+", created_at = "+created_at+", image = "+image+", send_to = "+send_to+", message_type = "+message_type+"]";
    }
}
