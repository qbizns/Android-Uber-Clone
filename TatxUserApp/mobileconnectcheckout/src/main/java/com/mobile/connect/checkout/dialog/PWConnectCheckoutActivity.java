...
import com.mobile.connect.checkout.dialog.fragment.ReviewAccountFragment;
...
import com.mobile.connect.payment.credit.ICreditCardParams;
import com.mobile.connect.payment.credit.PWCreditCardType;
import com.mobile.connect.payment.directdebit.INationalDirectDebitParams;
...
/**
 * Activity showing the checkout screens and providing payment functionality.
 * Provide the settings and payment info via two extras in the calling intent.
 * 
 * Provide {@link PWConnectCheckoutSettings} with key
 * {@link PWConnectCheckoutActivity#CONNECT_CHECKOUT_RESULT_SETTINGS} and
 * {@link PWPaymentParams} generated by
 * {@link PWPaymentParamsFactory#createGenericPaymentParams(double, PWCurrency, String)}
 * with key
 * {@link PWConnectCheckoutActivity#CONNECT_CHECKOUT_GENERIC_PAYMENT_PARAMS}.
 * 
 */
public class PWConnectCheckoutActivity extends FragmentActivity implements PWTransactionListener,
	...
	public static final String CONNECT_CHECKOUT_SETTINGS = "com.mobile.connect.checkout.meta.PWConnectCheckoutSettings";
	...
	private static final String TAG = "PWConnectCheckoutActivity";
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		_showToasts = getResources().getBoolean(R.bool.connect_checkout_show_toasts);
