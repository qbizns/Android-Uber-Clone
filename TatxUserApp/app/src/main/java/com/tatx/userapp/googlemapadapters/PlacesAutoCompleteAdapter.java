...
public class PlacesAutoCompleteAdapter
    ...
    public PlacesAutoCompleteAdapter(Context context, int resource, GoogleApiClient googleApiClient,
        ...
        mBounds = bounds;
        mPlaceFilter = filter;
        Log.i("PlacesAutoCompleteAdapter", "Query completed. Received 1" );
    }
    ...
    public Filter getFilter() {
        Filter filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                Log.i("PlacesAutoCompleteAdapter", "Query completed. Received.. 2");
            ...
            protected void publishResults(CharSequence constraint, FilterResults results) {
                if (results != null && results.count > 0) {
                    ...
                    Log.i("PlacesAutoCompleteAdapter", "Query completed. Received.. 3");
                } else {
                    // The API did not return any results, invalidate the data set.
                    //notifyDataSetInvalidated();
                    notifyItemRangeRemoved(0, getItemCount());
                    Log.i("PlacesAutoCompleteAdapter", "Query completed. Received.. 4");
                }
            }
        };
        return filter;
    ...
    private ArrayList<PlaceAutocomplete> getAutocomplete(CharSequence constraint) {
        if (mGoogleApiClient.isConnected()) {
            ...
            Log.i("PlacesAutoCompleteAdapter", "Query completed. Received.. 5");
