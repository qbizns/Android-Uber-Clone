...
/*
    ...
    public static final String UN_READ_NOTIFICATION_COUNT_CHANGE = TATX.getInstance().getPackageName() + ".UN_READ_NOTIFICATION_COUNT_CHANGE";
*/
...
/*
        ...
        IntentFilter intentFilter = new IntentFilter(PUSH_NOTIFICATION_RECEIVED);
