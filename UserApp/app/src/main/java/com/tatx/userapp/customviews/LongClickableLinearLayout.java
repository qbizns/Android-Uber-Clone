...
/**
 * Created by Venkateswarlu SKP on 01-09-2016.
 */
 ...
 */
public class LongClickableLinearLayout extends LinearLayout
{
    ...
    public LongClickableLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        Common.Log.i("getClass().getSimpleName() : " + getClass().getSimpleName());
        Common.Log.i("2");
        init(context, attrs);
    ...
    public LongClickableLinearLayout(Context context, AttributeSet attrs, int defStyleAttr)
    {
                        ...
                        setOnLongClickListener(new OnLongClickListener()
                        {
                            ...
                            public boolean onLongClick(View v)
                            {
                                ...
                                try
                                {
                                    ...
                                    method.invoke(getContext(),LongClickableLinearLayout.this);
                                ...
                                catch (NoSuchMethodException e)
                                {
                                    ...
                                    throw new IllegalStateException("Could not find a method " + methodName + "(View) in the activity " + getContext().getClass() + " for onKeyLongPress handler on view " + LongClickableLinearLayout.this.getClass() + idText, e);
    ...
    public LongClickableLinearLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes)
    {
