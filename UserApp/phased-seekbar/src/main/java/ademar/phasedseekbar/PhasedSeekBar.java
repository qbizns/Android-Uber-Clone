...
public class PhasedSeekBar extends View {
    ...
    private PhasedOnItemClickListener phasedOnItemClickListener;
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (action)
        {
            ...
            case MotionEvent.ACTION_UP:
                ...
                Log.i("SKP","?????? - getPreviousItem() : "+getPreviousItem());
                Log.i("SKP","?????? - getCurrentItem() : "+getCurrentItem());

                if (getCurrentItem() == getPreviousItem())
                {
                    Log.i("SKP","?????? - Item Clicked. : ");

                    phasedOnItemClickListener.onItemClick(getCurrentItem());
                }
    ...
    public void setOnItemClickListener(PhasedOnItemClickListener phasedOnItemClickListener)
    {
        this.phasedOnItemClickListener = phasedOnItemClickListener;
    }
}
